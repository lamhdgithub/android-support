package com.dev.coding.views.widget.dialog.loading
...
class RotateLoadingView : View {
    ...
    private fun initView(context: Context, attrs: AttributeSet?) {
        ...
        if (null != attrs) {
            ...
            loadingColor = typedArray.getColor(R.styleable.RotateLoadingView_loading_color, Color.WHITE)
            mWidth = typedArray.getDimensionPixelSize(R.styleable.RotateLoadingView_loading_width, dpToPx(context, DEFAULT_WIDTH.toFloat()))
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
        ...
        mLoadingBound = RectF((2 * mWidth).toFloat(), (2 * mWidth).toFloat(), (w - 2 * mWidth).toFloat(), (h - 2 * mWidth).toFloat())
        mShadowBound = RectF((2 * mWidth + mShadowPosition).toFloat(), (2 * mWidth + mShadowPosition).toFloat(), (w - 2 * mWidth + mShadowPosition).toFloat(), (h - 2 * mWidth + mShadowPosition).toFloat())
    }
